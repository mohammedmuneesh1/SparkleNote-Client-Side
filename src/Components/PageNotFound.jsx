...
export default function PageNotFound() {
  return (
    ...
    <div className="w-full lg:w-1/2">
        ...
        <p className="py-2 text-base text-gray-800 mb-4 sm:mb-8">Sorry about that! Please visit our hompage to get where you need to go.</p>
        <Link to="/" className=" w-full lg:w-auto my-4 border rounded-md px-1 sm:px-16 py-5 bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50">Go back to Homepage</Link>
    </div>
</div>
  )
}
